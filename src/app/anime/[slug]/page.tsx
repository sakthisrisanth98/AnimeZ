  ...
  return (
    <>
      ...
      <header className="flex justify-between items-center px-4 md:px-6 bg-[#111] h-[72px] relative z-30">
        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          <Image
            ...
            className="object-contain md:w-[170px] md:h-[46px]"
          />
        </div>
        {/* Center: Search */}
        ...
        {/* Right: Login */}
        <button className="bg-pink-400 hover:bg-pink-500 text-black px-3 md:px-4 py-2 rounded-md font-semibold text-sm md:text-base">
          Login
        </button>
      ...
      <div className="flex justify-center items-start relative">
        <div className="relative z-10 w-full max-w-8xl flex flex-col lg:flex-row gap-6 lg:gap-10 mt-[-5px] px-4 md:px-10 py-10 md:py-20 backdrop-blur-lg bg-[#201F35]/40 rounded-5xl">
          {/* Left: Poster */}
          <div className="flex flex-col items-center justify-start w-full lg:w-auto min-w-[160px] md:min-w-[220px] p-3">
            <div className="relative w-[160px] md:w-[190px] h-[240px] md:h-[300px]">
              <Image
                src={anime.image}
                alt={anime.title}
                fill
          ...
          <div className="flex-5 text-white flex flex-col">
            <nav className="mb-3 md:mb-5 text-xs md:text-sm font-medium flex items-center gap-2">
              <span className="text-white">Home</span>
              <span className="text-white/50 ">•</span>
              <span className="text-white">ONA</span>
              <span className="text-white/50 ">•</span>
              <span className="text-gray-400 font-bold truncate">{anime.title}</span>
            </nav>
            <h1 className="text-2xl md:text-4xl font-bold mb-4 md:mb-7">{anime.title}</h1>
            <div className="flex flex-wrap items-center mb-4 md:mb-8 gap-2 text-xs font-semibold">
              ...
              <span className="text-white flex items-center gap-2 select-none text-xs md:text-sm ">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4 md:mb-7">
              <Link href={`/anime/${anime.slug}/watch`} className="bg-pink-400 hover:bg-pink-500 transition text-black px-6 md:px-8 py-2 rounded-full text-base md:text-lg font-semibold shadow inline-block text-center">
                ▶ Watch now
              </Link>
              <button className="bg-white text-black text-center px-6 md:px-8 py-2 rounded-full text-base md:text-lg font-semibold border transition-colors duration-300 hover:bg-pink-500 hover:text-black">
                + Add to List
              </button>
            </div>
           ...
           <div className="flex flex-wrap items-center gap-2 md:gap-3 mt-3 pr-2 md:pr-6">
  <span className="text-pink-300 text-xs md:text-sm whitespace-nowrap">Share Anime</span>

  <button
    className="flex items-center gap-1 md:gap-2 bg-[#0088cc] text-white px-2 md:px-4 py-1 rounded-full text-xs md:text-sm transition-transform duration-300 hover:-translate-y-2"
  >
    <img src="/telegram.jpg" alt="Telegram" className="w-3 h-3 md:w-4 md:h-4" />
    <span className="hidden sm:inline">Telegram</span>
  </button>

  <button
    className="flex items-center gap-1 md:gap-2 bg-black text-white px-2 md:px-6 py-1 rounded-full text-xs md:text-sm transition-transform duration-300 hover:-translate-y-2"
  >
    <img src="/twitter.jpg" alt="Twitter" className="w-3 h-3 md:w-4 md:h-4" />
    <span className="hidden sm:inline">Twitter</span>
  </button>

  <button
    className="flex items-center gap-1 md:gap-2 bg-[#25D366] text-white px-2 md:px-4 py-1 rounded-full text-xs md:text-sm transition-transform duration-300 hover:-translate-y-2"
  >
    <img src="/whatshap.jpg" alt="WhatsApp" className="w-3 h-3 md:w-4 md:h-4" />
    <span className="hidden sm:inline">WhatsApp</span>
  </button>

  <button
    className="flex items-center gap-1 md:gap-2 bg-[#C13584] text-white px-2 md:px-4 py-1 rounded-full text-xs md:text-sm transition-transform duration-300 hover:-translate-y-2"
  >
    <img src="/instagram.jpg" alt="Instagram" className="w-3 h-3 md:w-4 md:h-4" />
    <span className="hidden sm:inline">Instagram</span>
  </button>

  <button
    className="flex items-center gap-1 md:gap-2 bg-[#1877F2] text-white px-2 md:px-4 py-1 rounded-full text-xs md:text-sm transition-transform duration-300 hover:-translate-y-2"
  >
    <img src="/facebook.jpg" alt="Facebook" className="w-3 h-3 md:w-4 md:h-4" />
    <span className="hidden sm:inline">Facebook</span>
  </button>

  <button className="bg-black p-1 md:p-2 rounded-full hover:scale-110 transition-transform duration-200">
    <Image src="/share.jpg" alt="Share" width={20} height={20} className="md:w-[25px] md:h-[25px]" />
  </button>
</div>
          </div>
          ...
          {/* Sidebar */}
          <aside
            className="w-full lg:w-72 flex-shrink-0 min-w-[250px] backdrop-blur-lg bg-[#232335]/70 rounded-5xl p-4 md:p-6 text-sm md:text-base text-white shadow-lg border border-white/10 h-auto lg:h-[515px] mt-0"
          >
  {/* Japanese */}
  <div className="mb-2">
    <b>Japanese:</b>
