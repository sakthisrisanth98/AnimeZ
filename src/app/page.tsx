...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HEADER */}
      <header className="flex justify-between items-center px-4 lg:px-6 bg-[#111] h-[72px] relative z-30">
        {/* Left: Hamburger + Logo */}
        <div className="flex items-center gap-2 lg:gap-6">
          ...
          <Image src="/animez.png" alt="AnimeZ" width={120} height={32} priority style={{ width: 'auto', height: 'auto' }} className="object-contain lg:w-[170px] lg:h-[46px]" />
        </div>
        {/* Center: Search */}
<div className="flex-1 mx-2 lg:mx-10 relative max-w-xs lg:max-w-sm">
  <input
    type="text"
    ...
    className="w-full bg-[#0b0b1b] text-white px-3 lg:px-4 py-2 pl-8 lg:pl-10 rounded-full border border-gray-700 focus:outline-none focus:ring-1 focus:ring-white-500 placeholder-gray-400 text-sm lg:text-base"
  />
  <FiSearch className="absolute top-2.5 left-2 lg:left-3 text-gray-400" size={16} />
  ...
  {showSearchResults && (
    ...
    >
      {filteredAnime.length > 0 ? (
        ...
        {/* Right: Login */}
        <button className="bg-pink-400 hover:bg-pink-500 text-black px-3 lg:px-4 py-2 rounded-md font-semibold text-sm lg:text-base">
          Login
        </button>
        ...
        {menuOpen && (
          <>
            ...
            <aside 
              id="navigation-menu"
              className={`
                fixed top-0 left-0 z-50 h-full max-h-screen w-[280px] lg:w-[325px] bg-[#121212] text-white
