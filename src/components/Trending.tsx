...
export default function Trending() {
  ...
  return (
    <section className="px-4 md:px-6 py-6 md:py-10 relative">
      <div className="flex items-center mb-4 md:mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-pink-400">Trending</h3>
      ...
      <div className="relative">
        <div
          ref={scrollRef}
          className="flex overflow-x-auto space-x-8 md:space-x-16 scroll-smooth px-4 md:px-[30px] pb-2 hide-scrollbar"
    ...
    key={index}
    className="relative flex-shrink-0 w-[120px] md:w-[180px] h-[180px] md:h-[260px] group bg-zinc-800 rounded-md"
  >
              {/* Image */}
              <Image
                src={anime.image}
              ...
              {/* Index Number */}
              <div className="absolute bottom-2 -left-6 md:-left-8 text-pink-500 text-base md:text-lg font-bold">
