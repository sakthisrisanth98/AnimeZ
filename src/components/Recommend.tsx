  ...
  return (
    <section className="px-4 md:px-6 pt-10 pb-0">
      ...
      <div className="flex items-center mb-4 md:mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-pink-400">Recommended for you</h3>
        <a href="/view-more" className="text-sm text-white hover:underline ml-auto md:mr-[320px]">
          View more &gt;
        </a>
      </div>
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="w-full lg:w-[300px] shrink-0">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-lg md:text-xl font-bold text-pink-400">Most Popular</h4>
          </div>
