...
export default function AnimeCardsSection() {
  ...
  return (
    <section className="px-4 md:px-6 pt-10 pb-0">
      ...
      <div className="flex items-center mb-4 md:mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-pink-400">Most Favourite</h3>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex bg-[#2a2a2a] rounded-md overflow-hidden">
              {['today', 'week', 'month'].map((tab) => (
                <button
                  key={tab}
                  className={`px-2 md:px-3 py-1 text-xs md:text-sm font-semibold transition-all duration-150 ${activeTab === tab ? 'bg-pink-400 text-white' : 'text-white'}`}
  ...
  key={index}
  className="flex gap-2 md:gap-3 items-start py-2 border-b border-zinc-700 last:border-none hover:bg-zinc-800/50 transition-colors cursor-pointer"
>
